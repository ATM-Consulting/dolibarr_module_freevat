 ...
 */
class freevatbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "freevat@freevat";
    public $boxlabel;
    public $depends = array("freevat");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/freevat/class/freevat.class.php";
